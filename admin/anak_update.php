...
$sql = "SELECT * FROM anak WHERE idanak='$id'";
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Data Anak</h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
			</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<form role="form" method="post" action="anak_update_process.php?id=<?php echo $id ?>">
									<div class="card-body">
                                        <div class="row">
											<div class="col-md-6">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="tmpt_lahir" class="form-control" value="<?php echo $data['tempat_lahir']; ?>">
												</div>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="kelamin" class="form-control" value="<?php echo $data['jenis_kelamin']; ?>">
												</div>
											</div>
										</div>
										<div class="row">
